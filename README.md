...
### 2. (Optional) Work through this tutorial for a quick introduction to Markdown writing formatting (10 min):
...
|:------|:-----:|:------------:|
| <a href="https://www.linkedin.com/in/profpan396">Amar Pan, M.Ed. <br>:india:</a> | Sr. Instructional Associate @ General Assembly <br><br> Technical Writer @ <a href="https://www.linode.com/docs/guides/">Linode</a>  <br> House Pan Founder  | Writing <br> :pencil2:
